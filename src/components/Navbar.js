  ...
  const Navbar = () => {
    ...
    return (
      <div>
        <nav className="navbar navbar-expand-lg navbar-light bg-light sticky-top" style={{ height: "70px", width: "100%", paddingLeft: "20px" }}>
    ...
    <li className="nav-item mx-4">
        ...
        <div className="dropdown-menus">
          <div className="dropdown-categorys">
            ...
            <Link to="/return-replacement" className="dropdown-items">
              RETURN REPLACEMENT
            </Link>
            <Link to="/lr-credits" className="dropdown-items">
              LR CREDITS
            </Link>
            <hr />
            <Link to="/support" className="dropdown-items">
              CUSTOMER SUPPORT
            </Link>
            <Link to="/faq" className="dropdown-items">
              FAQ & HELP
            </Link>
            <hr />
          </div>
